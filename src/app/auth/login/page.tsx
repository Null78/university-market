...
const Login = () => {
    ...
    return (
        <>
            <Image src="/assets/auth-bg.jpg" className="w-full h-64 object-contain" alt="Logo" width={1200} height={600} />
            <div className="flex flex-col items-center pt-12 justify-center p-4">
